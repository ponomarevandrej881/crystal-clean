...
<main>
    <div class="plate">
        <h2 class="header_1">Аккаунт {{$name}}</h2>
        ...
        @foreach($cardes as $card)
            <div class="back_sort">
                <div class="grid_block_two">

                    <div>
                        <div class="flexbox">
                            <div class="fieldsort">{{$card['adres']}}</div>
                            <div class="fieldsort">{{$card['type']}}</div>
                            <div class="fieldsort">{{$card['date']}}</div>
                        </div>
