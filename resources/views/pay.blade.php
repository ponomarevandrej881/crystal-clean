...
<main>
    <div class="plate">
        ...
        <div class="back">
            <div class="result">
                <p class="profile_data">Имя {{$name}}</p>
                <p class="profile_data">Фамилия {{$surname}}</p>
                <p class="profile_data">Телефон {{$telephone}}</p>
                <p class="profile_data">Адрес {{$adres}}</p>
            <p class="profile_data">Сумма {{$cost}} </p>
