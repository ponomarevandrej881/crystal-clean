...
<header>
    ...
    <a class="header_nav" href="profile"><?php echo e($login); ?></a><a class="header_nav" href="/logout">выйти</a>
</header>
<main>
    <div class="plate">
        <h2 class="header_1">Заказать услугу <?php echo e($name); ?></h2>
            <div class="card_pl">

                    <picture><source srcset="img/<?php echo e($img); ?>.webp" type="image/webp"><img src="img/<?php echo e($img); ?>.jpg" width="100%" height="100%"></picture>


            <div class="card_description">
                    <div class="card_texte" ><?php echo e($desc); ?><br><br><br><br><div class="price"><?php echo e($price); ?> рублей за еденицу</div> </div>
...
<?php /**PATH C:\Users\Andrey\Desktop\crystal_clean\lar\crystal\resources\views/card.blade.php ENDPATH**/ ?>